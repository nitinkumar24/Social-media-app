...
ActiveRecord::Schema.define(version: 20180211090253) do
  ...
  create_table "disikes", force: :cascade do |t|
    t.integer "user_id"
    t.integer "post_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_disikes_on_post_id"
    t.index ["user_id"], name: "index_disikes_on_user_id"
  end
  ...
  create_table "user_modes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_user_modes_on_user_id"
  end
